export const ASSETS = [
  ...
  { id: 'a3', name: 'social_post_03.jpg', type: 'image', size: '980 KB', dim: '1080×1080', campaign: 'Brand Refresh', lang: 'ko', brandScore: 45, status: 'violation', modified: '2026-04-16' },
...
export const BRAND_VIOLATIONS = [
  { id: 'v1', assetId: 'a3', assetName: 'social_post_03.jpg', type: 'color', description: '브랜드 컬러 불일치 - Primary Blue #0066CC 대신 #3399FF 사용', severity: 'high', scoreBefore: 45, scoreAfter: 88 },
  { id: 'v2', assetId: 'a3', assetName: 'social_post_03.jpg', type: 'logo', description: '로고 여백 부족 - 최소 여백 24px 미달 (현재 12px)', severity: 'high', scoreBefore: 45, scoreAfter: 88 },
...
export const AI_FIX_INBOX = [
  { id: 'f1', assetId: 'a3', assetName: 'social_post_03.jpg', violations: ['색상 톤', '로고 여백'], requester: 'Kim', requestedAt: '2026-04-16 14:30', status: 'pending' as const, scoreBefore: 45, scoreAfter: 88 },
