...
export const ASSETS: Asset[] = [
  ...
  },
  {
    ...
    format: 'jpeg',
    taxonomyPath: ['마케팅 자산', '캠페인', 'Brand Refresh', '제품 라이프스타일'],
    dominantColors: ['#047857', '#ECFDF5', '#334155'],
    semanticHints: ['제품', '라이프스타일', '실내', '헤드셋'],
    visualBucket: 1,
    langGroupId: null,
    duplicateGroupId: 'dup-near-1',
    assetKind: 'photo',
  ...
  {
    id: 'a11',
    name: 'summer_social_headset_01.png',
    type: 'image',
    size: '1.2 MB',
    dim: '1080×1080',
    campaign: '2026 Summer',
    ...
    channels: ['instagram'],
    format: 'png',
    taxonomyPath: ['마케팅 자산', '소셜', '2026 Summer', '피드'],
    dominantColors: ['#1D4ED8', '#F8FAFC', '#CBD5E1'],
    semanticHints: ['헤드셋', '소셜', '피드', '정사각형', '여름', '제품'],
    visualBucket: 1,
    langGroupId: 'lg-summer-social',
    duplicateGroupId: null,
    assetKind: 'photo',
  },
  {
    id: 'a12',
    name: 'summer_social_headset_02.png',
    type: 'image',
    size: '1.5 MB',
    dim: '1080×1080',
    campaign: '2026 Summer',
    ...
    format: 'png',
    taxonomyPath: ['마케팅 자산', '소셜', '2026 Summer', '피드'],
    dominantColors: ['#1D4ED8', '#FBBF24', '#1E293B'],
    semanticHints: ['헤드셋', '소셜', '라이프스타일', '착용컷', '여름'],
    visualBucket: 2,
    langGroupId: 'lg-summer-social',
    duplicateGroupId: null,
    assetKind: 'photo',
  ...
  {
    id: 'a13',
    name: 'summer_social_headset_03.png',
    type: 'image',
    size: '1.1 MB',
    dim: '1080×1080',
    campaign: '2026 Summer',
    ...
    format: 'png',
    taxonomyPath: ['마케팅 자산', '소셜', '2026 Summer', '피드'],
    dominantColors: ['#BAE6FD', '#F1F5F9', '#0EA5E9'],
    semanticHints: ['헤드셋', '소셜', '스타일링', '오브제', '여름'],
    visualBucket: 3,
    langGroupId: 'lg-summer-social',
    duplicateGroupId: null,
    assetKind: 'photo',
  ...
  {
    id: 'a14',
    name: 'summer_banner_violation.png',
    type: 'image',
    size: '1.8 MB',
    dim: '1920×1080',
    campaign: '2026 Summer',
    ...
    format: 'png',
    taxonomyPath: ['마케팅 자산', '캠페인', '2026 Summer', '프로모션'],
    dominantColors: ['#F97316', '#FEF3C7', '#7C3AED'],
    semanticHints: ['배너', '여름', '헤드셋', '위반', '프로모션', '와이드'],
    visualBucket: 2,
    langGroupId: null,
    duplicateGroupId: null,
    assetKind: 'banner',
...
export const BRAND_VIOLATIONS = [
  ...
  { id: 'v6', assetId: 'a14', assetName: 'summer_banner_violation.png', type: 'color', description: '브랜드 주색 이탈 — 오렌지/퍼플 계열 사용, Primary Blue #1D4ED8 미적용', severity: 'high', scoreBefore: 48, scoreAfter: 91 },
  { id: 'v7', assetId: 'a14', assetName: 'summer_banner_violation.png', type: 'logo', description: '로고 안전 여백 부족 — 최소 32px 필요, 현재 8px', severity: 'high', scoreBefore: 48, scoreAfter: 91 },
] as const;
...
export const AI_FIX_INBOX = [
  ...
  { id: 'f5', assetId: 'a14', assetName: 'summer_banner_violation.png', violations: ['브랜드 주색 이탈', '로고 여백 부족'], requester: 'Choi', requestedAt: '2026-04-17 10:00', status: 'pending' as const, scoreBefore: 48, scoreAfter: 91 },
];
